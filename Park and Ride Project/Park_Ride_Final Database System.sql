...
GO 
CREATE PROCEDURE spInsertIntoPR_EMP_MAINT(
	@PR varchar(60),
	@MT varchar(50),
	@FN varchar(60),
	@LN varchar(60),
...
EXEC spInsertIntoPR_EMP_MAINT @PR = 'Redmond P&R', @MT = 'Striping', @FN = 'Jacky',
@LN = 'Lee', @Date = '2019-05-06 18:00:00'
...
-- 
GO 
CREATE PROCEDURE spInsertIntoNote(
	@PRN varchar(60),
	@NT varchar(50),
	@Date date,
	@NC varchar(300))
